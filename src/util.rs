...
pub fn identify_file(file_content:&std::vec::Vec<u8>) -> Result<FileParams, &'static str>{
	let recognized_files = [
		FileParams {
			...
			physics_mode_force_hc_bytes: [0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x8A, 0x45, 0x0C, 0x84, 0xC0, 0x74, 0x07],
			name: "1.66a",
		},
		FileParams {
			check_sum: "E88C07B9D383479746E856D083E86C240CFF4DACC245BF83463EC6313D2BC169",
			normal_mode_offset: 0x5E2710,
			// mov ecx,dword ptr ds:[F8A21C]
			normal_mode_original_bytes: [0x8B, 0x0D, 0x1C, 0xA2, 0xF8, 0x00],
			havok_offset: 0xB41CC4,
